...
export default function BrandsPage() {
	...
	useEffect(() => {
		const fetchSubcategories = async () => {
			if (selectedCategory) {
				const subdata = await getsubcatgeorybycategory(
					selectedCategory
				);
	...
	return (
		<div className="flex flex-col gap-4">
			<h1 className="text-4xl font-bold">Brands Master</h1>
			<div className="">
						...
						<div className="mb-4">
							<Form {...form}>
								...
								>
									...
									<div className="md:grid gap-8 w-1/2">
										<FormField
											control={form.control}
											name="name"
											render={({ field }) => (
				...
				<div className="grid grid-cols-3 md:grid-cols-4 mt-8">
