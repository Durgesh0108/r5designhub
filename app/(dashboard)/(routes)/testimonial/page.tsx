    ...
    <>
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-8">
          <div className="rounded-lg bg-[#f0f0f0] border-black border-2 p-8">
            <div className="flex justify-between items-center mb-4">
          ...
          <ul className="overflow-hidden bg-[#f0f0f0] rounded-lg border-black p-4 border-2 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <ul className="bg-[#f0f0f0] rounded-lg border-black p-4 border-2 flex flex-col gap-4">
